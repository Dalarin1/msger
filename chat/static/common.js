/* ============================================================
   common.js — общая логика для всех страниц Oleg Chat
   Подключать ПОСЛЕ разметки (перед закрывающим </body>),
   ДО инлайн-скрипта конкретной страницы.
   Ожидает в DOM: #authOverlay/#authCard (auth-модалка),
   #my-name (имя в шапке), #fileInput, #pendingFiles,
   #uploadStatus. #recordVM — опционально (если есть кнопка ГС).
   ============================================================ */

// ── общее состояние ──────────────────────────────────────────────────────
let accessToken = null;
let myId = null;
// Список загруженных вложений, ожидающих отправки: [{url, mime, original_name}]
